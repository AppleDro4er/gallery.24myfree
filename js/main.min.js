...
$("#auth").click(function(){var e=$.trim($("#username").val()),a=$.trim($("#password1").val());ShowLoading(""),$.ajax({type:"POST",url:"login.php",data:{user_login:e,user_password1:a},success:function(e){e[0]?(HideLoading(""),window.location.href="//gallery.24myfree.ru/"):(HideLoading(""),DLEalert(e[2],message_info))},dataType:"json"})});
/*! ScrollToTop */
